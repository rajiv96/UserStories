...
@SpringBootTest
public class UserStoriesLimitOrderTest {
	...
	public void insertSingleMarketOrderCompletesSuccessfully() {
		...
		assertThat("limittime should be 5", 5,equalTo(tradeOrder.getLimittime()));
		assertThat("tradetype should be limit", tradetype.limit,equalTo(tradeOrder.getTradetype()));
	}
	}
